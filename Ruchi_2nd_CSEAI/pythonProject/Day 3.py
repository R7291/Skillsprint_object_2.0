...
def getContours(imgDiale,imgContours):
    ...
    :param imgDiale: we are getting the coordinates of edges to draw the contours
    :param imgContours: After getting coordinates we draw the contours to original image
    :return:
    """
...
while True:
    ...
    # to find the correct threshold values we need to create trackbar to get optimal threshold vales
